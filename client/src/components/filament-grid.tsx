  ...
  return (
    <section className="lg:w-4/4">
      <div className="flex justify-between items-center mb-4">
        <h2 className="text-xl font-medium text-neutral-400">Filament Bestand</h2>
        <div className="flex items-center space-x-3">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="remainingAsc">Füllstand (Niedrig-Hoch)</SelectItem>
              <SelectItem value="remainingDesc">Füllstand (Hoch-Niedrig)</SelectItem>
            </SelectContent>
          </Select>
      ...
      >
        ...
        {sortedFilaments.length === 0 && (
          <div className="col-span-full p-8 text-center text-neutral-300">
            ...
            <p className="text-lg font-medium">Keine Filamente gefunden</p>
            <p className="mt-1">Füge dein erstes Filament hinzu, um es hier zu sehen.</p>
          </div>
        )}
      </div>
    </section>
